...
def visualize(
    *,
    ...
    print("In main : visualize()cfg model dataloader_vis accelerate identifier num_batches output_dir")
...
def sample(
    *,
    ...
    print("In main : sample()cfg model dataloader accelerate output_dir")
        ...
        for sample_idx in range(cfg.run.num_samples):
            ...
            for i in range(len(output)):
                ...
                metadata = dict(index=i, sequence_name=batch.sequence_name, sequence_category=batch.sequence_category,
                                ...
                                image_path=batch.image_path, depth_path=batch.depth_path,
