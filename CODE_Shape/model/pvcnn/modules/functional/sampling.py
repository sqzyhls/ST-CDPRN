...
class Gather(Function):
    ...
    def forward(ctx, features, indices):
        ...
        """
        print("In sampling: forward()ctx features indices")
    ...
    def backward(ctx, grad_output):
        print("In sampling: backward()ctx grad_output")
...
def furthest_point_sample(coords, num_samples):
    ...
    """
    print("In sampling: furthest_point_sample()coords num_samples")
...
def logits_mask(coords, logits, num_points_per_object):
    ...
    """
    print("In sampling: logits_mask()coords logits num_points_per_object")
