...
def sample_b(size: Size, sigma: float) -> Tensor:
    ...
    Returns:
        b (Tensor): b matrix
    """
    print("In simple model utils : sample_b()size digma")
...
def map_positional_encoding(v: Tensor, freq_bands: Tensor) -> Tensor:
    ...
    """
    print("In simple model utils : map_positional_encoding()v freq_bands")
    pe = [v]
...
def map_fourier_features(v: Tensor, b: Tensor) -> Tensor:
    ...
    """
    print("In simple model utils : map_fourier_features()v b")
...
class FeatureMapping(nn.Module):
    ...
    def forward(self, v: Tensor) -> Tensor:
        ...
        """
        print("In simple model utils : forward()self v")
...
class FeedForward(nn.Module):
    ...
    def forward(self, x: Tensor, coords: Tensor = None) -> Tensor:
        ...
        print("In simple model utils : forward()self x coords")
...
class BasePointModel(nn.Module):
    ...
    def get_layers(self):
        print("In simple model utils : get_layers()self")
    ...
    def prepare_inputs(self, inputs: torch.Tensor, t: torch.Tensor) -> torch.Tensor:
        ...
        print("In simple model utils : prepare_inputs()self inputs t")
    ...
    def get_global_tensors(self, x: Tensor):
        print("In simple model utils : get_global_tensors()self x")
        B, N, D = x.shape
    ...
    def forward(self, inputs: torch.Tensor, t: torch.Tensor):
        print("In simple model utils : forward()self inputs t")
        raise NotImplementedError('This method should be implemented by subclasses')