...
@torch.no_grad()
def _update_teacher_model(now_step, encoder, decoder, attention, encoder_tea, decoder_tea, attention_tea,
                          keep_rate=0.996):
    ...
    for epoch_idx in range(init_epoch, cfg.TRAIN.NUM_EPOCHS):
        ...
        for batch_idx, (taxonomy_names, sample_names, rendering_images, unlabel_name,
            ...
            with torch.no_grad():
                ...
                generated_unlabel_tea = torch.ge(generated_unlabel_tea, 0.3).float()
            ...
            total_step += 1
            encoder_tea, decoder_tea, attention_tea = _update_teacher_model(epoch_idx, encoder_stu, decoder_stu,
                                                                            attention_stu,
                                                                            encoder_tea, decoder_tea, attention_tea,
                                                                            0.99996)
            # Tick / tock
