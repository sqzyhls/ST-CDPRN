...
class LoggingConfig:
    wandb: bool = True
    wandb_project: str = 'shape_airplane'
...
"""
@dataclass
class SHAPENET3DConfig(PointCloudDatasetConfig):
    type: str = 'shapenet3d'
    root: str = os.getenv('SHAPENET3DV2_DATASET_ROOT')
    category: str = 'sofa'
    subset_name: str = 'fewview_dev'
    mask_images: bool = '${model.use_mask}'
"""
...
class ShapeNetR2N2Config(PointCloudDatasetConfig):
    ...
    root: str = os.getenv('SHAPENET_R2N2_DATASET_ROOT')
    r2n2_dir: str = "${dataset.root}/ShapeNet"
...
#cs.store(group='dataset', name='shapenet_r2n2', node=SHAPENET3DConfig)
# TODO
