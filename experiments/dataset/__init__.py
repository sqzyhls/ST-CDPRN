...
def get_dataset(cfg: ProjectConfig):
    ...
    if cfg.dataset.type == 'co3dv2':
        ...
        r2n2_dataset_train = R2N2("train", dataset_cfg.shapenet_dir, dataset_cfg.r2n2_dir, dataset_cfg.splits_file, return_voxels=False, voxels_rel_path='ShapeNetVox32')
        dataloader_train = DataLoader(r2n2_dataset_train, batch_size=dataloader_cfg.batch_size, collate_fn=collate_batched_R2N2)
        r2n2_dataset_val = R2N2("val", dataset_cfg.shapenet_dir, dataset_cfg.r2n2_dir, dataset_cfg.splits_file, return_voxels=False, voxels_rel_path='ShapeNetVox32')
        dataloader_val = DataLoader(r2n2_dataset_val, batch_size=dataloader_cfg.batch_size, collate_fn=collate_batched_R2N2)
        r2n2_dataset_test = R2N2("test", dataset_cfg.shapenet_dir, dataset_cfg.r2n2_dir, dataset_cfg.splits_file, return_voxels=False, voxels_rel_path='ShapeNetVox32')
